### python3 main_tcgnn.py --dataset /scratch/general/vast/u1362105/suitesparse/12month1/12month1.npz --dim 128 --hidden 10000 --single_kernel
...
print("-,filepath,filename,m,k,n,nnz")
print("dummy,"+path+","+filename+","+str(nrows)+","+str(ncols)+","+str(args.dim)+","+str(nnz))
#########################################
