...
int main(int argc, char** argv) {
	...
	float milliseconds = time_taken * 1e3;
	float gflop =  2*total_params/1e6*B_num_cols;
	std::cout << "CUSPARSE Time (ms): "<< milliseconds/num_repetitions 
	<< "  GFLOPs: " << gflop/(milliseconds/num_repetitions) << std::endl;
